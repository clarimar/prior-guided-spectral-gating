...
\begin{enumerate}
  ...
  \item \textbf{Abstract} (second sentence): Gasoline PLS comparator
        ...
        ``$R^2=0.93$ vs $0.98$''.
  \item \textbf{Section~4.2 (Evaluation Protocol)}: the paragraph on
  ...
  \item \textbf{Section~5.1 (Multi-Dataset Performance)}: the paragraph
  ...
  \item \textbf{Figure~3 caption}: the ``$86$--$93\%$ of PLS
        ...
        ``$86$--$95\%$''.
  \item \textbf{Section~6.1 (Addressing Key Concerns)}: the third
        ...
        baseline.
  \item \textbf{Section~7 (Conclusion), first paragraph}: PLS
