...
\medskip
\noindent The revised text (Section~5.2, ``Evaluation Protocol'') now
reads:
...
\begin{itemize}
  ...
  \item Section~5.2 (Evaluation Protocol): revised paragraph on PLS
  ...
  \item Section~6.2 (Multi-Dataset Performance): paragraph discussing
  ...
  \item Section~7 (Addressing Potential Criticisms): third bullet
        reworded; the ``gap only $1.3\%$'' argument replaced by an
        honest acknowledgment of the $4.7\%$ gap under fair comparison.
  \item Section~8 (Conclusion): PLS comparator range updated from
