"""
Recriar Figura 2 com legenda no lado direito centralizada
"""
...
print("="*70)
print("FIXING FIGURE 2: Moving legend to center right")
print("="*70)
...
# LEGENDA NO LADO DIREITO, CENTRALIZADA VERTICALMENTE
...
plt.show()  # Opcional: mostrar preview
