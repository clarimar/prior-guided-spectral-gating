"""
Figura 2 com legenda fora do gráfico (à direita)
"""
...
fig, ax = plt.subplots(figsize=(9, 5))  # Figura ligeiramente mais larga
...
ax.text(0.05, 0.87, 'Good Performance\n($R^2 > 0.85$)', 
...
# LEGENDA COMPLETAMENTE FORA DO GRÁFICO À DIREITA
...
print("✓ Figure 2 updated with legend outside (right)")
