"""
Figura 3 - Ajustar posição do texto "Good Performance" (sem sobrepor PLSR)
"""
...
print("="*70)
print("FIXING FIGURE 3: Moving 'Good Performance' text to avoid PLSR overlap")
print("="*70)
...
# TEXTO "GOOD PERFORMANCE" MOVIDO MAIS PARA A DIREITA (x=50 → evita PLSR)
...
print("\nChanges:")
print("  - PLS → PLSR ✓")
print("  - Labels beside circles ✓")
print("  - 'Good Performance' text moved right (x=50) to avoid PLSR overlap ✓")
print("="*70)
