"""
Figura 2 - Legenda no CANTO SUPERIOR DIREITO (sem sobrepor barras)
"""
...
print("="*70)
print("FIXING FIGURE 2: Legend to UPPER RIGHT (no overlap)")
print("="*70)
...
# LEGENDA NO CANTO SUPERIOR DIREITO (não sobrepõe barras)
...
print("\nLegend position: UPPER RIGHT (no bar overlap)")
print("Text 'Good Performance': UNCHANGED at x=2.35")
print("="*70)
