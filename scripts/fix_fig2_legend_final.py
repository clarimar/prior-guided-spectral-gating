"""
Figura 2 - Legenda à direita, texto "Good Performance" no lugar original
"""
...
print("="*70)
print("FIXING FIGURE 2: Legend to center right, text in original position")
print("="*70)
...
# TEXTO NA POSIÇÃO ORIGINAL (DIREITA) - NÃO MODIFICADO
...
# APENAS A LEGENDA MUDOU: upper left → center right
...
print("\nChanges:")
print("  - Legend: upper left → center right ✓")
print("  - Text 'Good Performance': position UNCHANGED (x=2.35) ✓")
print("="*70)
